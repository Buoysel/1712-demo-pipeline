...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*
		 * Validate user through our Business Logic Classes, ask Servce Classes
		 */
		...
		if(clientUser != null){
			...
			session.setAttribute("user", clientUser); //User is the variable name the developer defines
